...
// Easily append, remove, or modify items here to upgrade your categories in the future
const categories = [
  {
    id: "heavyweight-tees",
  ...
  },
  {
    ...
    category: "",
    count: "12 Items",
    linkUrl: "/shop/trackpants-cargos",
    imgUrl:
  ...
  },
  {
    ...
    category: "",
    count: "9 Items",
    linkUrl: "/shop/outerwear-hoodies",
    imgUrl:
  ...
  return (
    <section className="w-full bg-[#181a1f] text-white py-16 px-4 md:px-12 select-none">
      <div className="max-w-7xl mx-auto">
        ...
        {/* ==================== AUTOMATED RESPONSIVE GRID ==================== */}
        {/* Scales flawlessly from 1 column on mobile to 2 on tablets and 4 on desktop */}
          ...
          {categories.map((cat) => (
            ...
            >
              ...
              <div className="absolute inset-0 w-full h-full z-0">
                ...
                />
                {/* Minimal Gradient Overlay for absolute label contrast */}
              ...
              <div className="absolute bottom-5 left-5 right-5 z-10 flex items-end justify-between pointer-events-none">
                ...
                {/* Micro-Interaction Arrow Button */}
